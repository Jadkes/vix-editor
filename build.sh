...
# Directories
SOURCE_DIR="/home/jad/vix-editor/src"
BIN_DIR="/home/jad/vix-editor"
INSTALL_DIR="/home/jad/.local/bin"

# Compiler Flags
CFLAGS="-I/usr/include/python3.12 -std=c++17 -Wall"
LDFLAGS="-lpython3.12 -lncurses"

# 1. Compile Vix Editor
echo ">> Building Vix Editor..."
g++ "$SOURCE_DIR/vix_editor.cpp" -o "$BIN_DIR/vix" $CFLAGS $LDFLAGS
